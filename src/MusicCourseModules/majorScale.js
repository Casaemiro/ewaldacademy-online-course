...
import maj from '../images/maj.jpg'
import maj2 from '../images/maj2.png'
const MajorScale = () => {
    return (
        <div className="majorScale-section">
            ...
            <p className='intro-text'>
                The formular below is the what we'll use to get the notes of the major scale on all 12 keys. The concept of intervals will be used extensively in this section. On the formular, <span className='extra-link'>T</span> means tone or whole step and <span className='extra-link'>st</span> means semitone or half step.
            </p>
            <div className='row px-3'>
                <img src={maj} alt="" className='col-md-12' />
            </div>
            <p> The most important thing to remember are the intervals between the different notes. Its more important that you remember that between 1 and 2 is tone, between 2 and 3 is tone, between 3 and 4 is semitone, between 4 and 5 is tone, between 5 and 6 is tone, between 6 and 7 is tone, between 7 and 8 is semitone.
            </p>
            ...
            <div className='row px-3'>
                <img src={maj2} alt="" className='col-md-12' />
            </div>
        </div>
    );
}
